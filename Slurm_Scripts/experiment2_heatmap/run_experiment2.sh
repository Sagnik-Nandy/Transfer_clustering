...
#SBATCH -o /home/nandy.15/Research/Transfer_clustering/Slurm_Scripts/experiment2_heatmap/Output_Messages/slurm_out_%A_%a_%x_%j_%t.out
#SBATCH -e /home/nandy.15/Research/Transfer_clustering/Slurm_Scripts/experiment2_heatmap/Error_Messages/slurm_err_%A_%a_%x_%j_%t.err
...
"$CONDA_PREFIX/bin/python" \
  "$PROJECT_ROOT/Experiments_Script/run_experiment2.py" \
  "$regime" "$seed"
