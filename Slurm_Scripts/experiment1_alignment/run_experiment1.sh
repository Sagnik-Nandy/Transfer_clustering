...
#SBATCH -o /home/nandy.15/Research/Transfer_clustering/Slurm_Scripts/experiment1_alignment/Output_Messages/slurm_out_%A_%a_%x_%j_%t.out
#SBATCH -e /home/nandy.15/Research/Transfer_clustering/Slurm_Scripts/experiment1_alignment/Error_Messages/slurm_err_%A_%a_%x_%j_%t.err
...
"$CONDA_PREFIX/bin/python" \
  "$PROJECT_ROOT/Experiments_Script/run_experiment1.py" \
  "$regime" "$seed"
