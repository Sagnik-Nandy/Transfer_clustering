...
same simplification used for TGMM before it was dropped from this project.
...
# multiplicative-update NMF is likely nowhere near converged on 5000-gene
# data, which is the probable cause of the degenerate (ari=0.0) fits seen
# on the lung atlas data before this change. mix itself stays fixed at
# SCRNA_MIX (0.5) -- the paper's own mix-sweep-plus-unsupervised-KTA-
# selection glue code (experiments_utils.py) isn't in the public repo, so
