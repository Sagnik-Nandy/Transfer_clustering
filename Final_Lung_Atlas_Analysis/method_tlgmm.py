"""TL-GMM (Tian, Weng, Xia & Feng, arXiv:2209.15224), multi-cluster (K=13),
fused across all 3 sources.
...
(2) ALIGNMENT (Algorithm 6, supplementary Section S.2.2). With R=13
    clusters, naively fusing discriminant coefficients across the 3
    ...
    permutations) which is infeasible for our R=13 (13! ~ 6 billion). Our
