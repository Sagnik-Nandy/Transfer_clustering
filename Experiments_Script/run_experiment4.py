#!/usr/bin/env python
"""Experiment 4: comparison against two published comparator methods,
across all three of Experiment 1's aspect-ratio regimes (R1, R2, R3).
...
# Same three aspect-ratio regimes as Experiment 1 (Section 3), duplicated
# here rather than imported -- see the module-level convention note above
# run_experiment1.py's simulation building blocks.
REGIMES = {
...
# from run_experiment1.py rather than shared, per this project's convention
# of one self-contained script per experiment.
# ---------------------------------------------------------------------------
