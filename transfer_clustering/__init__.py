...
Gaussian mixture models, implementing Sections 2 and 4 of Chakraborty &
Nandy, "Transfer Learning in High-Dimensional Clustering: Minimax
Thresholds and Applications in Single-Cell Data."
...
two_community
    ...
    (adaptive selection), Algorithm 1 (Meta Algorithm for
    Transfer-Assisted Clustering with One Source), and Algorithm 2
    (Adaptive Transfer-Assisted Clustering for Two Communities) for the
    K=2 two-community model.
relaxed_kmeans
    Giraud & Verzelen (2019) relaxed K-means SDP (arXiv:1807.07547),
    used as the target-based clustering routine for K>2.
ts_clust
    Algorithm 5 (TSClust): spectral initialization + Lloyd refinement.
multi_cluster
    Section 4 and Algorithm 3 (Adaptive Transfer-Assisted Projected
