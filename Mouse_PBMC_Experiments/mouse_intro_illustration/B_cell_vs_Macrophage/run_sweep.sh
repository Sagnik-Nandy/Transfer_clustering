...
#SBATCH -o /path/to/Transfer_clustering/Mouse_PBMC_Experiments/mouse_intro_illustration/logs/bcell_macrophage_%A_%a_%x_%j_%t.out
#SBATCH -e /path/to/Transfer_clustering/Mouse_PBMC_Experiments/mouse_intro_illustration/logs/bcell_macrophage_%A_%a_%x_%j_%t.err
...
cd "$PROJECT_ROOT/Mouse_PBMC_Experiments/mouse_intro_illustration/B_cell_vs_Macrophage"

task_id=$SLURM_ARRAY_TASK_ID
echo "Running task_id=$task_id"

"$CONDA_PREFIX/bin/python" \
  "$PROJECT_ROOT/Mouse_PBMC_Experiments/mouse_intro_illustration/B_cell_vs_Macrophage/run_sweep.py" \
  "$task_id"
