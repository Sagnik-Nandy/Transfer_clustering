> **Vendored code.** This directory is a copy of [nicococo/scRNA](https://github.com/nicococo/scRNA),
> developed by Nico Goernitz, Bettina Mieth, Marina Vidovic, and Alex Gutteridge. It is used here as
> the NMF-based ("scRNA"/NMF) comparator method in Table 1 of this repository's paper (see
> `Mouse_PBMC_Experiments/Final_Mouse_PBMC_Analysis/method_scrna.py` for the driver code); all credit
> for the method and this implementation belongs to its original authors.
